...
home_url = 'http://gz.lianjia.com/'
auth_url = 'https://passport.lianjia.com/cas/login?service=http%3A%2F%2Fgz.lianjia.com%2F'
chengjiao_url = 'http://gz.lianjia.com/chengjiao/'
...
# 获取lianjia_uuid
req = urllib2.Request('http://gz.lianjia.com/')
opener.open(req)
# 初始化表单
...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'https://passport.lianjia.com/cas/login?service=http%3A%2F%2Fgz.lianjia.com%2F',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.111 Safari/537.36',
    'Upgrade-Insecure-Requests': '1',
